<?php
/**
 * Mobile More Menu Walker Class
 * 
 * Custom walker for the fullscreen mobile more menu items
 * 
 ...
 * Mobile More Menu Walker Class
 */
class Nova_More_Menu_Walker extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        // Output the item
        $output .= $indent . '<a href="' . esc_url($item->url) . '" class="more-menu-item">' . $n;
    ...
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        // We don't handle submenus in mobile more menu
        return;
    }
